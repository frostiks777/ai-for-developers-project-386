  ...
  return (
    ...
    >
      ...
      <div className="scrollbar-thin flex min-h-0 flex-1 flex-col gap-1.5 overflow-y-auto">
        <a
          href={`#${BOOKINGS_SECTION_ID}`}
          aria-current="page"
          onClick={(event) => scrollToSection(event, BOOKINGS_SECTION_ID)}
          className="flex h-11 items-center gap-2.5 rounded-lg bg-accent px-3 text-[15px] font-semibold text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
